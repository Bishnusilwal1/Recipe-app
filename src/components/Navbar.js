...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white ">
          ...
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-2xl font-bold text-black">
                F<span className="text-orange-500">o</span>ody
              </span>
            </div>
            <div className=" mt-3 hidden md:ml-6 md:flex md:space-x-8 ">
              <Link
                className=" ml-40 text-gray-900 hover:text-orange-500 px-3 py-2 text-sm font-medium"
                to="/"
              >
                Home
              </Link>
      ...
      {isOpen && (
        <div className="md:hidden absolute bg-white right-0">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
              className="block text-gray-900 hover:text-orange-500 px-3 py-2 rounded-md text-base font-medium"
              to="/"
            >
              Home
            </Link>
